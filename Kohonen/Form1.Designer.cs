namespace Kohonen
{
    partial class Form1
    {
      ...
      this.label4.Text = "Współczynnik uczenia:";
      // 
      // numericUpDown2
      // 
      ...
      this.label6.Text = "Aktualny rozmiar siatki:";
      // 
      // label7
      // 
      ...
      this.label7.Text = "Zmień rozmiar siatki:";
      // 
      // button2
      // 
      this.button2.Location = new System.Drawing.Point(61, 180);
      ...
      this.Name = "Form1";
      this.Text = "Kompresja obrazów klasyfikatorem Kohonena";
